...
\lib\VisualStudio directory. That's it, with your IDE set up like this,
...
public static void main(String argv[])
{
	...
	*/
	...
	IAnimatedMeshSceneNode node = smgr.addAnimatedMeshSceneNode(mesh, null, -1, new vector3df(0,0,0), new vector3df(0,0,0), new vector3df(1,1,1));
	...
	*/
	smgr.addCameraSceneNode(null, new vector3df(0,10,-60), new vector3df(0,0,0), -1);
